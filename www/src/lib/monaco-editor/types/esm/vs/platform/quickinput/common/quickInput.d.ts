declare module "monaco-editor/esm/vs/platform/quickinput/common/quickInput" {
	import type { Uri as URI } from "monaco-editor/esm/vs/editor/editor.api";
	...
	export interface IPickOptions<T extends IQuickPickItem> {
		...
		onDidTriggerItemButton?: (
			context: IQuickPickItemButtonContext<T>,
		) => void;
	...
	export declare class QuickPickItemScorerAccessor
		implements IItemAccessor<IQuickPickItemWithResource>
	{
		...
		getItemDescription(
			entry: IQuickPickItemWithResource,
		): string | undefined;
	...
	export declare const IQuickInputService: unknown;
